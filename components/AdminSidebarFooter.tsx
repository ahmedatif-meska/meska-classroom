...
/**
 * Shared admin sidebar footer (signed-in email + sign-out). Rendered on every
 * admin dashboard surface so the left nav is identical across pages.
 */
export default function AdminSidebarFooter({ email }: { email: string }) {
