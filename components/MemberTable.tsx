...
export default function MemberTable({
  ...
  // Any member can be reassigned to another wave — whether currently assigned or
  // unassigned (e.g. their wave was deleted).
  ...
  // Intersect with the current roster so stale ids never count or get submitted.
  const selectedVisible = selected.filter((id) =>
    members.some((m) => m.id === id)
  );
  const allSelected = hasMembers && selectedVisible.length === members.length;
