...
/**
 * Shared student sidebar footer (avatar initial + name + sign-out). Rendered on
 * every student dashboard surface (Home and each week) so the left nav is
 * identical across pages — mirrors AdminSidebarFooter.
 */
export default function StudentSidebarFooter({ name }: { name: string }) {
